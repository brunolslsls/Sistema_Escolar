...
$pag = @$_GET["pag"];  // @ = serve para evitar que mostra alertas de variaveis indefinidas
$menu1 = "secretarios";
$menu2 = "menu2";
$menu3 = "menu3";
$menu4 = "menu4";
    ...
    <div id="wrapper">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="index.php?pag=<?php echo $menu1 ?>">Secretarios</a> <!-- a = link, href= define o arquivo que vamos acessar a pois de de clica nesse link-->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!--container-fluid = faz que items ocupem 100% de comprimento da tela  -->
                <div class="container-fluid">
                    <!-- incluindo os arquivos no projeto -->
                    <?php if (@$pag == null) {
